...
OWNER_USERNAME = getenv("OWNER_USERNAME", "Captainf1")
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/movies_club3")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/movies_club7")
